!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(){s("#newDiner").on("click",function(e){e.preventDefault(),console.log("name adding");var t=s("#diner").val();if(s("#diner").val()){s("#dinerName").append('<li><span class="remove">X  </span>'+t+"</li>");var n=Object.create(l);n.id=f,n.name=t,n.dishes=[],p.push(n),console.log(p),s("#diner, #newDiner").hide(),s("#selectDish").show(),s("#newDish").show(),s("#diner").val("")}else alert("Please type a name.")}),s(document).on("click",".remove",function(e){e.preventDefault(),console.log("remove"),p.pop(),console.log(p),s(this).parent("li").remove(),s("#diner, #newDiner").show(),s("#dinerPreview").text(""),s("#selectDish").hide(),s("#newDish").hide(),s("#diner").val("")})}function i(){s("#selectDish").on("change",function(e){e.preventDefault(),console.log("dish adding"),s("#submitDiner").show()}),s("#newDish").on("click",function(e){e.preventDefault(),console.log("addddddddd");var t=s("#selectDish :selected").text(),n=s("#selectDish").val(),r=Object.create(u);r.id=c,r.name=t,r.cost=n;for(var i=0;i<p.length;i++)p[i].id==f&&p[i].dishes.push(r);console.log(p),s("#dinerPreview").append('<li><span class="delete" id="'+c+'">X  </span>'+n+" - "+t+"</li>"),s("#selectDish").find(s("option")).attr("selected",!1),c++}),s(document).on("click",".delete",function(e){e.preventDefault(),console.log("delete");for(var t=s(this).attr("id"),n=0;n<p.length;n++)if(p[n].id==f)for(var r=0;r<p[n].dishes.length;r++)p[n].dishes[r].id==t&&p[n].dishes.splice(r,1);console.log(p),s(this).parent("li").remove()})}function o(){s("#submitDiner").on("click",function(e){e.preventDefault(),console.log("submitting");for(var t=0;t<p.length;t++)if(p[t].id==f){s("#dinerBreakdown").append('<li class="dinerName"><strong>'+p[t].name+"</strong></li>");for(var n=0;n<p[t].dishes.length;n++){s("#totalBill").append("<li>"+p[t].dishes[n].cost+" - "+p[t].dishes[n].name+"</li>");var r=parseInt(100*p[t].dishes[n].cost)/100;d+=r,p[t].subtotal+=r,s("#dinerBreakdown").append("<li>"+p[t].dishes[n].cost+" - "+p[t].dishes[n].name+"</li>")}var i=p[t].subtotal.toFixed(2);s("#dinerBreakdown").append('<li class="subtotalDiner">'+i+" - Subtotal</li>")}console.log(p),console.log(d);var o=d.toFixed(2),a=d*h,u=Math.round(100*a)/100,l=u.toFixed(2),c=d+u,g=c.toFixed(2);f++,s("#dinerName, #dinerPreview").empty(),s("#selectDish, #submitDiner, #newDish").hide(),s("#diner, #newDiner").show(),s("#subtotalGross").text(o+" - Subtotal"),s("#tax").text(l+" - Tax"),s("#afterTax").text(g+" - TOTAL")})}var s=n(1),a=n(2),u={id:"",name:"",cost:""},l={id:"",name:"",dishes:[],subtotal:0},c=0,f=0,p=[],d=0,h=.05;s(function(){s("#selectDish").hide(),s("#submitDiner").hide(),s("#newDish").hide(),r();for(var e=document.getElementById("selectDish"),t=0;t<a.length;t++){var n=document.createElement("option");n.textContent=a[t].dish,n.value=a[t].price,e.appendChild(n)}i(),o(),s("#diner").on("keydown",function(e){13===e.keyCode&&(e.preventDefault(),s("#newDiner").click())})})},function(e,t,n){var r,i;/*!
