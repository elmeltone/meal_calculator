!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r=n(1),i=n(2),o=n(3),s=n(4),a=n(5),u=[],l=[],i=function(){r("#newDiner").on("click",function(e){e.preventDefault(),console.log("name adding");var t=r("#diner").val();r("#diner").val()?(r("#dinerName").append('<li><span class="remove">X  </span>'+t+"</li>"),t=Object.create(u),l.push(t),r("#diner, #newDiner").hide(),r("#selectDish").show(),r("#newDish").show(),r("#diner").val("")):alert("Please type a name.")}),r(document).on("click",".remove",function(e){e.preventDefault(),console.log("remove"),l.pop(inputValue),r(this).parent("li").remove(),r("#diner, #newDiner").show(),r("#selectDish").hide(),r("#newDish").hide(),r("#diner").val("")})};r(function(){r("#selectDish").hide(),r("#submitDiner").hide(),r("#newDish").hide();for(var e=document.getElementById("selectDish"),t=0;t<a.length;t++){var n=document.createElement("option");n.textContent=a[t].dish,n.value=a[t].price,e.appendChild(n)}i(),o(),s(),r("#diner").on("keydown",function(e){13===e.keyCode&&(e.preventDefault(),r("#newDiner").click())})})},function(e,t,n){var r,i;/*!
