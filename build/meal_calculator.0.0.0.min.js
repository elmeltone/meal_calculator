!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(){a("#newDiner").on("click",function(e){e.preventDefault(),console.log("name adding");var t=a("#diner").val();if(a("#diner").val()){a("#dinerName").append('<li><span class="remove">X  </span>'+t+"</li>");var n=Object.create(c);n.id=p,n.name=t,n.dishes=[],d.push(n),console.log(d),a("#diner, #newDiner").hide(),a("#selectDish").show(),a("#newDish").show(),a("#diner").val("")}else alert("Please type a name.")}),a(document).on("click",".remove",function(e){e.preventDefault(),console.log("remove"),d.pop(),console.log(d),a(this).parent("li").remove(),a("#diner, #newDiner").show(),a("#dinerPreview").text(""),a("#selectDish").hide(),a("#newDish").hide(),a("#diner").val("")})}function i(){a("#selectDish").on("change",function(e){e.preventDefault(),a("#submitDiner").show();var t=a("#selectDish :selected").text(),n=a("#selectDish").val(),r=Object.create(l);r.id=f,r.name=t,r.cost=n;for(var i=0;i<d.length;i++)d[i].id==p&&d[i].dishes.push(r);console.log(d),a("#dinerPreview").append('<li><span class="delete" id="'+f+'">X  </span>'+n+" - "+t+"</li>"),a("#selectDish").find(a("option")).attr("selected",!1),f++}),a(document).on("click",".delete",function(e){e.preventDefault(),console.log("delete");for(var t=a(this).attr("id"),n=0;n<d.length;n++)if(d[n].id==p)for(var r=0;r<d[n].dishes.length;r++)d[n].dishes[r].id==t&&d[n].dishes.splice(r,1);console.log(d),a(this).parent("li").remove()})}function o(){a("#submitDiner").on("click",function(e){e.preventDefault(),console.log("submitting");for(var t=0;t<d.length;t++)if(d[t].id==p){a("#dinerBreakdown").append('<li class="dinerName"><br><strong>'+d[t].name+"</strong></li>");for(var n=0;n<d[t].dishes.length;n++){a("#totalBill").append("<li>"+d[t].dishes[n].cost+" - "+d[t].dishes[n].name+"</li>");var r=parseInt(100*d[t].dishes[n].cost)/100;h+=r,d[t].subtotal+=r,a("#dinerBreakdown").append("<li>"+d[t].dishes[n].cost+" - "+d[t].dishes[n].name+"</li>")}var i=d[t].subtotal.toFixed(2);a("#dinerBreakdown").append('<li class="subtotalDiner">'+i+" - Subtotal</li>")}console.log(d),console.log(h);var o=h.toFixed(2),s=h*g,u=Math.round(100*s)/100,l=u.toFixed(2),c=h+u,f=c.toFixed(2);p++,a("#dinerName, #dinerPreview").empty(),a("#selectDish, #submitDiner, #newDish").hide(),a("#diner").show(),a("#subtotalGross").text(o+" - Subtotal"),a("#tax").text(l+" - Tax"),a("#afterTax").text(f+" - TOTAL")})}function s(){a("#calcTT").on("click",function(){a("#dinerBreakdown").empty();for(var e=0;e<d.length;e++){a("#dinerBreakdown").append('<li class="dinerName"><br><strong>'+d[e].name+"</strong></li>");for(var t=0;t<d[e].dishes.length;t++)a("#dinerBreakdown").append("<li>"+d[e].dishes[t].cost+" - "+d[e].dishes[t].name+"</li>");var n=(h.toFixed(2),h*g),r=Math.round(100*n)/100,i=(r.toFixed(2),h+r),o=(i.toFixed(2),d[e].subtotal.toFixed(2));a("#dinerBreakdown").append('<li class="subtotalDiner">'+o+" - Subtotal</li>");var s=parseInt(d[e].subtotal*g*100)/100,u=s.toFixed(2);a("#dinerBreakdown").append('<li class="taxDiner">'+u+" - Tax</li>");var l=parseInt(.2*d[e].subtotal*100)/100,c=l.toFixed(2);a("#dinerBreakdown").append('<li class="tipDiner">'+c+" - Tip</li>");var f=d[e].subtotal+s+l,p=f.toFixed(2);a("#dinerBreakdown").append('<li class="totalDiner">'+p+" - Diner Total</li>")}})}var a=n(1),u=n(2),l={id:"",name:"",cost:""},c={id:"",name:"",dishes:[],subtotal:0},f=0,p=0,d=[],h=0,g=.05;a(function(){a("#newDiner, #selectDish, #submitDiner, #newDish").hide(),r();for(var e=document.getElementById("selectDish"),t=0;t<u.length;t++){var n=document.createElement("option");n.textContent=u[t].dish,n.value=u[t].price,e.appendChild(n)}i(),o(),s(),a("#diner").on("keydown",function(e){13===e.keyCode&&(e.preventDefault(),a("#newDiner").click())})})},function(e,t,n){var r,i;/*!
