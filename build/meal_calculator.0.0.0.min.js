!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(){o("#newDiner").on("click",function(e){e.preventDefault(),console.log("name adding");var t=o("#diner").val();o("#diner").val()?(o("#dinerName").append('<li><span class="remove">X  </span>'+t+"</li>"),t=Object.create(u),l.push(t),o("#diner, #newDiner").hide(),o("#selectDish").show(),o("#newDish").show(),o("#diner").val("")):alert("Please type a name.")}),o(document).on("click",".remove",function(e){e.preventDefault(),console.log("remove"),l.pop(),o(this).parent("li").remove(),o("#diner, #newDiner").show(),o("#selectDish").hide(),o("#newDish").hide(),o("#diner").val("")})}function i(){o("#selectDish").on("change",function(e){e.preventDefault(),console.log("dish adding"),o("#submitDiner").show()}),o("#newDish").on("click",function(e){e.preventDefault(),console.log("addddddddd");var t=o("#selectDish :selected").text(),n=o("#selectDish").val(),r=Object.create(a);r.name=t,r.cost=n,l.push(r),o("#dinerPreview").append('<li><span class="delete">X  </span>'+n+" - "+t+"</li>"),o("#selectDish").find(o("option")).attr("selected",!1)}),o(document).on("click",".delete",function(e){e.preventDefault(),console.log("delete"),l.splice(this.index,1),console.log(l),o(this).parent("li").remove()})}var o=n(1),s=n(5),a={name:"",cost:""},u=[],l=[],c=function(){o("#submitDiner").on("click",function(e){e.preventDefault(),console.log("submitting"),console.log(l),l.forEach(function(e){o("#totalBill").append("<li>"+e.cost+" - "+e.name+"</li>"),o("#dinerBreakdown").append("<li>"+e+"<br>"+e.cost+" - "+e.name+"</li>")}),l.pop(),o("#dinerName, #dinerPreview").empty(),o("#selectDish, #submitDiner, #newDish").hide(),o("#diner, #newDiner").show()})};o(function(){o("#selectDish").hide(),o("#submitDiner").hide(),o("#newDish").hide();for(var e=document.getElementById("selectDish"),t=0;t<s.length;t++){var n=document.createElement("option");n.textContent=s[t].dish,n.value=s[t].price,e.appendChild(n)}r(),i(),c(),o("#diner").on("keydown",function(e){13===e.keyCode&&(e.preventDefault(),o("#newDiner").click())})})},function(e,t,n){var r,i;/*!
