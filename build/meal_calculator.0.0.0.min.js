!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(){o("#newDiner").on("click",function(e){e.preventDefault(),console.log("name adding");var t=o("#diner").val();if(o("#diner").val()){o("#dinerName").append('<li><span class="remove">X  </span>'+t+"</li>");var n=Object.create(u);n.id=c,n.name=t,n.dishes=[],f.push(n),console.log(f),o("#diner, #newDiner").hide(),o("#selectDish").show(),o("#newDish").show(),o("#diner").val("")}else alert("Please type a name.")}),o(document).on("click",".remove",function(e){e.preventDefault(),console.log("remove"),f.pop(),console.log(f),o(this).parent("li").remove(),o("#diner, #newDiner").show(),o("#dinerPreview").text(""),o("#selectDish").hide(),o("#newDish").hide(),o("#diner").val("")})}function i(){o("#selectDish").on("change",function(e){e.preventDefault(),console.log("dish adding"),o("#submitDiner").show()}),o("#newDish").on("click",function(e){e.preventDefault(),console.log("addddddddd");var t=o("#selectDish :selected").text(),n=o("#selectDish").val(),r=Object.create(a);r.id=l,r.name=t,r.cost=n;for(var i=0;i<f.length;i++)f[i].id==c&&f[i].dishes.push(r);console.log(f),o("#dinerPreview").append('<li><span class="delete" id="'+l+'">X  </span>'+n+" - "+t+"</li>"),o("#selectDish").find(o("option")).attr("selected",!1),l++}),o(document).on("click",".delete",function(e){e.preventDefault(),console.log("delete");for(var t=o(this).attr("id"),n=0;n<f.length;n++)if(f[n].id==c)for(var r=0;r<f[n].dishes.length;r++)f[n].dishes[r].id==t&&f[n].dishes.splice(r,1);console.log(f),o(this).parent("li").remove()})}var o=n(1),s=n(2),a={id:"",name:"",cost:""},u={id:"",name:"",dishes:[]},l=0,c=0,f=[],p=function(){o("#submitDiner").on("click",function(e){e.preventDefault(),console.log("submitting");for(var t=0;t<f.length;t++)if(f[t].id==c){o("#dinerBreakdown").append('<li class="dinerName"><strong>'+f[t].name+"</strong></li>");for(var n=0;n<f[t].dishes.length;n++)o("#totalBill").append("<li>"+f[t].dishes[n].cost+" - "+f[t].dishes[n].name+"</li>"),o("#dinerBreakdown").append("<li>"+f[t].dishes[n].cost+" - "+f[t].dishes[n].name+"</li>")}console.log(f),c++,o("#dinerName, #dinerPreview").empty(),o("#selectDish, #submitDiner, #newDish").hide(),o("#diner, #newDiner").show()})};o(function(){o("#selectDish").hide(),o("#submitDiner").hide(),o("#newDish").hide();for(var e=document.getElementById("selectDish"),t=0;t<s.length;t++){var n=document.createElement("option");n.textContent=s[t].dish,n.value=s[t].price,e.appendChild(n)}r(),i(),p(),o("#diner").on("keydown",function(e){13===e.keyCode&&(e.preventDefault(),o("#newDiner").click())})})},function(e,t,n){var r,i;/*!
